...
class DreamTeamTests(unittest.TestCase):
    ...
    def test_too_many_goalies(self):
        ...
        self.assertEqual(len(dream_team.dream_team), Constants.MAX_GOALKEEPER)
    ...
    def test_no_goalie(self):
        ...
        self.assertEqual(sum(player['pos'] == 1 for player in dream_team.dream_team), Constants.MIN_GOALKEEPER)
    ...
    def test_too_many_defenders(self):
        ...
        self.assertEqual(sum(player['pos'] == 2 for player in dream_team.dream_team), Constants.MAX_DEFENDER)
    ...
    def test_not_enough_defenders(self):
        ...
        self.assertEqual(sum(player['pos'] == 2 for player in dream_team.dream_team), Constants.MIN_DEFENDER)
    ...
    def test_not_enough_midfielders(self):
        ...
        self.assertEqual(sum(player['pos'] == 3 for player in dream_team.dream_team), Constants.MIN_MIDFIELDER)
    ...
    def test_too_many_midfielders(self):
        ...
        self.assertEqual(sum(player['pos'] == 3 for player in dream_team.dream_team), Constants.MAX_MIDFIELDER)
    ...
    def test_not_enough_strikers(self):
        ...
        self.assertEqual(sum(player['pos'] == 4 for player in dream_team.dream_team), Constants.MIN_STRIKER)
    ...
    def test_too_many_strikers(self):
        ...
        self.assertEqual(sum(player['pos'] == 4 for player in dream_team.dream_team), Constants.MAX_STRIKER)
    ...
    def test_team_validity(self):
        ...
        self.assertEqual(len(dream_team.dream_team), 11)
        self.assertEqual(sum(player['pos'] == 1 for player in dream_team.dream_team), Constants.MAX_GOALKEEPER)
        self.assertEqual(sum(player['pos'] == 1 for player in dream_team.dream_team), Constants.MIN_GOALKEEPER)
        self.assertLessEqual(sum(player['pos'] == 2 for player in dream_team.dream_team), Constants.MAX_DEFENDER)
        self.assertGreaterEqual(sum(player['pos'] == 2 for player in dream_team.dream_team), Constants.MIN_DEFENDER)
        self.assertGreaterEqual(sum(player['pos'] == 3 for player in dream_team.dream_team), Constants.MIN_MIDFIELDER)
        self.assertLessEqual(sum(player['pos'] == 3 for player in dream_team.dream_team), Constants.MAX_MIDFIELDER)
        self.assertGreaterEqual(sum(player['pos'] == 4 for player in dream_team.dream_team), Constants.MIN_STRIKER)
        self.assertLessEqual(sum(player['pos'] == 4 for player in dream_team.dream_team), Constants.MAX_STRIKER)
